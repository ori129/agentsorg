...
**"Corporation"** means the legal entity that signs this Agreement and on whose
behalf Contributions are submitted.
...
Corporation that are necessarily infringed by the Corporation's Contribution(s) alone
or by combination of such Contribution(s) with the Project.

---

## 4. Corporation Retains Copyright

This Agreement does not transfer ownership of the Corporation's copyright. The
Corporation retains full copyright in its Contributions.
...
a. It is legally entitled to grant the above licenses.

b. Each Contribution submitted by Authorized Employees is an original creation of
   the Corporation or was obtained by the Corporation under a license that permits
   the grants made in this Agreement.

c. The Corporation has authority to bind its employees and contractors to this
   Agreement.
...
The Corporation will designate a primary contact for communications related to this
Agreement:
...
To sign this Corporate CLA, open a GitHub issue titled `[Corporate CLA] <Company Name>`
and include:

- Company legal name
- Point of contact details (name, title, email)
- A statement confirming acceptance of this Agreement
- List of GitHub usernames authorized to contribute on behalf of the Corporation

The Project Owner will countersign and record the agreement.
